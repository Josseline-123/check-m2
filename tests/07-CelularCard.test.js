...
describe('<CelularCard />', () => {
   ...
   describe('Estructura', () => {
      ...
      it('Debe renderizar un "h3" que muestre la propiedad {modelo} de cada celular', () => {
         ...
         expect(celularCard(celulares[1]).find('h3').at(0).text()).toBe(
            'Edge S'
         );
      ...
      it('Debe renderizar un <p> que contenga el texto "Precio: " seguido de la propiedad {precio} de cada celular', () => {
      ...
      it('Debe asociar una etiqueta <Link> con el "modelo" de cada celular y redirigir a "/celulares/:id"', () => {
